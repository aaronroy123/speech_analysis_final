...
def test(data_dir, model_path):
    ...
    print(f"Speech Model Accuracy: {acc:.4f}")
    ...
    print("Saved confusion matrix to Results/plots/speech_confusion_matrix.png")
    ...
    plt.title('t-SNE of Speech Emotion Features')
    plt.savefig('Results/plots/speech_tsne.png')
    print("Saved t-SNE plot to Results/plots/speech_tsne.png")

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--data_dir', type=str, required=True, help="Path to TESS dataset")
    parser.add_argument('--model_path', type=str, default='models/speech_pipeline/weights/speech_model.pth')
